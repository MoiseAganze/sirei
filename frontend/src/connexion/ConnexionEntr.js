...
function ConnexionEntr(props) {
  return (
    <div className="w-full min-h-screen flex justify-center">
      <form className="sm:w-screen md:w-1/2 p-5 m-2 flex flex-col gap-3 border border-spacing-2">
        <div class="text-center mb-5">
          <h1 class="text-4xl font-bold p-5 shadow-md w-auto">
            Connexion d'entrepreneur
          </h1>
        </div>
        ...
        <div className="flex justify-between">
          <div className="flex flex-col">
            <Link className="ml-4 btn-link" to="/inscription/entrepreneur">
              inscription
            </Link>
            <Link
